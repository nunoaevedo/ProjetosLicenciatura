...
class UsuarioController extends Controller {
	...
	public function cadastro(Request $request) {
		...
		$imagem = "https://icon-library.com/images/default-user-icon/default-user-icon-4.jpg";
	...
	public function allUsers(Request $request) {
		$nome = $request->nome;
		$users = User::where('name', 'like', '%' . $nome . '%')->get();

		if ($users) {
			return ['status' => true, 'users' => $users];
		} else {
			return ['status' => false, 'erro' => 'não foi possivel'];
		}

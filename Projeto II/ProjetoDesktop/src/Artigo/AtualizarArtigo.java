 ...
 * @author Nuno
 */
public class AtualizarArtigo extends javax.swing.JFrame {

    DefaultTableModel tabela = new DefaultTableModel();
    
    public AtualizarArtigo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarArtigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarArtigo().setVisible(true);
            }
        });
    }

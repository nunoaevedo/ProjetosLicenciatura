 ...
 * @author Nuno
 */
public class NovoRececionista extends javax.swing.JFrame {

    /**
     * Creates new form BalancoAnual
     */
    public NovoRececionista() {
    ...
    private Boolean verCampos(){
        return NomeField.getText().isEmpty() || ApelidoField.getText().isEmpty() || EmailField.getText().isEmpty() || RuaField.getText().isEmpty() || UtilizadorField.getText().isEmpty()
                ...
                || TelefoneField.getText().isEmpty() || SexoBox.getSelectedIndex() == 0;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Novo Rececionista");
        ...
        if(verCampos()) JOptionPane.showMessageDialog(null, "Preencha todos os campos.");
            ...
            if(!cpController.existeCodpostal(CodPostalField.getText())){
                try {
                    ...
                    Logger.getLogger(NovoRececionista.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            try {
                ...
                int i = 1;
                while(recController.existeRec(i)){
                    i++;
                }                       
                ...
                rec.setNome(NomeField.getText());
                rec.setApelido(ApelidoField.getText());
                rec.setEmail(EmailField.getText());
                rec.setMorada(RuaField.getText());            
                rec.setCodPostal(cp);           
                rec.setIdUser(u);          
                rec.setDataNasc(DataNascField.getDate());
                rec.setNif(Integer.parseInt(NIFField.getText()));
                rec.setTelefone(Integer.parseInt(TelefoneField.getText()));           
                rec.setSexo(sexo);           
                rec.setId(i);

                try {
                    recController.create(rec);
                    JOptionPane.showMessageDialog(null, "Rececionista registado com sucesso.");
                    GerirMedico gm = new GerirMedico();
                    gm.setVisible(true);
                    dispose();
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Hove um problema registar o rececionista.");
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Hove um problema registar o nome de utilizador do rececionista.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovoRececionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovoRececionista().setVisible(true);
            }
        });
    }

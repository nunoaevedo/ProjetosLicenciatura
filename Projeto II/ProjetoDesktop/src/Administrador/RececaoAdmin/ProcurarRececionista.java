 ...
 * @author Nuno
 */
public class ProcurarRececionista extends javax.swing.JFrame {
   ...
   private void loadDataPassword(String nome){
    ...
    private void TabelaListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaListaMouseClicked
        ...
        ProcurarRececionista1 p1 = new ProcurarRececionista1();
        p1.setRec(rec);
        p1.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcurarRececionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProcurarRececionista().setVisible(true);
            }
        });
    }

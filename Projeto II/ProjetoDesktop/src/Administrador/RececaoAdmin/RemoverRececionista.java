...
import BLL.RececionistaJpaController;
 ...
 * @author Nuno
 */
public class RemoverRececionista extends javax.swing.JFrame {
    ...
    private void loadData(){
        RececionistaJpaController recController = new RececionistaJpaController();
        encontrou = false;
        Object obj[] = new Object[9];
        
        for(Object o : recController.findRececionistaEntities()){
            obj[0] = ((Rececionista)o).getNome();
            obj[1] = ((Rececionista)o).getApelido(); 
            obj[2] = ((Rececionista)o).getDataNasc();
            obj[3] = ((Rececionista)o).getNif();
            if(null == ((Rececionista)o).getSexo()) obj[4] = "";
            else switch (((Rececionista)o).getSexo()) {
                case 0:
                    obj[4] = "Masculino";
                    break;
                case 1:
            ...
            obj[5] = ((Rececionista)o).getEmail();
            obj[6] = ((Rececionista)o).getTelefone();    
            obj[7] = ((Rececionista)o).getIdUser().getUsername();
            
            tabela.addRow(obj);
            encontrou = true;
        }
        if (!encontrou){
            JOptionPane.showMessageDialog(null, "Não existem rececionistas registados.");
   ...
   private void loadData(String nome){
        ...
        for(Object o : recController.findRececionistaEntities(nome)){
            obj[0] = ((Rececionista)o).getNome();
            obj[1] = ((Rececionista)o).getApelido(); 
            obj[2] = ((Rececionista)o).getDataNasc();
            obj[3] = ((Rececionista)o).getNif();
        ...
        if (!encontrou)
            JOptionPane.showMessageDialog(null, "Não existem rececionistas registados com o nome fornecido.");
    ...
    private void loadDataPassword(){
        ...
        for(Object o : recController.findRececionistaEntities()){
            ...
            obj[6] = ((Rececionista)o).getTelefone();    
            obj[7] = ((Rececionista)o).getIdUser().getUsername();
            obj[8] = ((Rececionista)o).getIdUser().getPassword();
   ...
   private void loadDataPassword(String nome){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Remover Rececionista");
        ...
        jLabel2.setText("Nome do Rececionista:");
    ...
    private void RetrocederMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RetrocederMouseClicked
        GerirRececao gm = new GerirRececao();
        gm.setVisible(true);
        dispose();                
    ...
    private void TabelaListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaListaMouseClicked
        ...
        Rececionista rec = new Rececionista();
        RececionistaJpaController recController = new RececionistaJpaController();
        UtilizadorJpaController ucontroller = new UtilizadorJpaController();

        rec = recController.findRecByUser(user);

        int input = JOptionPane.showConfirmDialog(null,
            "Deseja eliminar este rececionista?", "Selecione uma opção",JOptionPane.YES_NO_OPTION);

        if(input == 0){
            try {
                recController.destroy(rec.getId());
                ucontroller.destroy(rec.getIdUser().getId());
                JOptionPane.showMessageDialog(null, "Rececionista eliminado.");
                GerirRececao gm = new GerirRececao();
                gm.setVisible(true);
                dispose();
            } catch (NonexistentEntityException ex) {
                JOptionPane.showMessageDialog(null, "Problema a eliminar rececionista.");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverRececionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverRececionista().setVisible(true);
            }
        });
    }

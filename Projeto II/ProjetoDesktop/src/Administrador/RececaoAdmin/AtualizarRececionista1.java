 ...
 * @author Nuno
 */
public class AtualizarRececionista1 extends javax.swing.JFrame {

    private Rececionista rec;
    
    public AtualizarRececionista1() {
    ...
    private void preencheCampos(){
        ...
        SexoBox.setSelectedIndex(rec.getSexo()+1);
    ...
    private void AtualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AtualizarMouseClicked
        ...
        if(verCampos()) JOptionPane.showMessageDialog(null, "Preencha todos os campos.");
        else if(!rec.getIdUser().getUsername().equals(UtilizadorField.getText()) && rec.getIdUser().getId() != recController.findRecByUser(UtilizadorField.getText()).getId())
            ...
            if(!cpController.existeCodpostal(CodPostalField.getText())){
                try {
                    ...
                    Logger.getLogger(AtualizarRececionista1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }

            
            
            Utilizador u = rec.getIdUser();
            ...
            try {
                    ...
                    try {
                        recController.edit(rec);
                        JOptionPane.showMessageDialog(null, "Rececionista editado com sucesso.");
                        GerirMedico gm = new GerirMedico();
                        gm.setVisible(true);
                        dispose();
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(null, "Hove um problema editar o rececionista.");
                    }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Hove um problema editar o nome de utilizador do rececionista.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarRececionista1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarRececionista1().setVisible(true);
            }
        });
    }

 ...
 * @author Nuno
 */
public class AtualizarRececionista extends javax.swing.JFrame {
   ...
   private void loadDataPassword(String nome){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Atualizar Rececionista");
    ...
    private void TabelaListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaListaMouseClicked
        ...
        RececionistaJpaController recController = new RececionistaJpaController();
        Rececionista rec = recController.findRecByUser(user);
        
        AtualizarRececionista1 p1 = new AtualizarRececionista1();
        p1.setRec(rec);
        p1.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarRececionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarRececionista().setVisible(true);
            }
        });
    }

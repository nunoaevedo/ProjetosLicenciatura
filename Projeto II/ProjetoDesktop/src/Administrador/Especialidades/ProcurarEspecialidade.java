 ...
 * @author Nuno
 */
public class ProcurarEspecialidade extends javax.swing.JFrame {

    
    DefaultTableModel tabela = new DefaultTableModel();
    
    
    public ProcurarEspecialidade() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Procurar Especialidade");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcurarEspecialidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProcurarEspecialidade().setVisible(true);
            }
        });
    }

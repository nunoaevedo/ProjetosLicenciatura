 ...
 * @author Nuno
 */
public class ProcurarMedico1 extends javax.swing.JFrame {

    private Medico med;
    
    
    
    public ProcurarMedico1() {
    ...
    private void preencheCampos(){
        ...
        EspecialidadeField.setText(med.getIdEsp().getNome());
        if(med.getSexo() == 0)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(EspecialidadeField, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
    ...
    private void RetrocederMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RetrocederMouseClicked
        ProcurarMedico gm = new ProcurarMedico();
        gm.setVisible(true);
        dispose();                
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcurarMedico1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProcurarMedico1().setVisible(true);
            }
        });
    }

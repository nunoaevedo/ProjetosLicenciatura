...
public class BalancoAnual extends javax.swing.JFrame {
    ...
    public BalancoAnual() {
        ...
        Object colunas[] = {"Ano", "Total Base", "Total Iva", "Total"};
    ...
    private void loadData(){
        ...
        Query q = em.createNativeQuery("SELECT extract(year from c.data) as year, sum(f.preco_base) as base, sum(f.iva) as IVA, sum(f.preco_total) as TOTAL\n" +

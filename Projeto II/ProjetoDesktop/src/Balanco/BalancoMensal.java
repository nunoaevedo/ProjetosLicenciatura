...
public class BalancoMensal extends javax.swing.JFrame {
    ...
    public BalancoMensal() {
        ...
        Object colunas[] = {"Ano", "Mes", "Total Base", "Total Iva", "Total"};
    ...
    private void loadData(){
        ...
        Query q = em.createNativeQuery("SELECT extract(year from c.data) as year, extract(month from c.data) as mon, sum(f.preco_base) as base, sum(f.iva) as IVA, sum(f.preco_total) as TOTAL\n" +
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Balanço Mensal");

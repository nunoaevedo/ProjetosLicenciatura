 ...
 * @author Nuno
 */
public class RemoverConsulta extends javax.swing.JFrame {
    ...
    private void TabelaListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaListaMouseClicked
        ...
        int input = JOptionPane.showConfirmDialog(null,
            "Deseja eliminar esta consulta?", "Selecione uma opção",JOptionPane.YES_NO_OPTION);
        ...
        if(input == 0){
            try {
                ...
                JOptionPane.showMessageDialog(null, "Problema a eliminar consulta.");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverConsulta().setVisible(true);
            }
        });
    }

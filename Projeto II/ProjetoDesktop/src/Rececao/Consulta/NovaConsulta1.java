 ...
 * @author Nuno
 */
public class NovaConsulta1 extends javax.swing.JFrame {
    ...
    private Boolean verCampos(){
        return EspecialidadeBox.getSelectedIndex() == 0 || null == DataField.getDate().toString() ||  Hora.getSelectedIndex() == 0 || Minuto.getSelectedIndex() == 0;
    }
        ...
        if(!verCampos()){
            ...
            if(d1.after(d)){
                ...
                if(mc.existeMedComEsp(e)){
                    cons.setData(d1);
                    NovaConsulta2 nc = new NovaConsulta2();
                    nc.setInfo(cons, e);
                    nc.setVisible(true);
                    dispose();
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovaConsulta1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovaConsulta1().setVisible(true);
            }
        });
    }

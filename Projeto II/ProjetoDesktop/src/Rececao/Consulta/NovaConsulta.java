...
public class NovaConsulta extends javax.swing.JFrame {
    ...
    public NovaConsulta() {
        ...
        Object colunas[] = {"Nome", "Apelido", "Data de Nascimento", "NIF", "Sexo", "Email", "Telefone", "NISS", "Utilizador"};
    ...
    private void loadData(){
        ...
        for(Paciente p : pacController.findPacienteEntities()){
            obj[0] = p.getNome();
            obj[1] = p.getApelido(); 
            obj[2] = p.getDataNasc();
            obj[3] = p.getNif();
            if(null == p.getSexo()) obj[4] = "";
            else switch (p.getSexo()) {
                case 0:
                    obj[4] = "Masculino";
                    break;
                case 1:
    ...
    private void TabelaListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaListaMouseClicked
        ...
        String user = (TabelaLista.getValueAt(row, 8)).toString();
        PacienteJpaController pacController = new PacienteJpaController();
        Paciente pac = pacController.findPacienteByUser(user);
        
        NovaConsulta1 p1 = new NovaConsulta1();
        p1.setPac(pac);
        p1.setVisible(true);
        dispose();

 ...
 * @author Nuno
 */
public class NovaConsulta2 extends javax.swing.JFrame {
    ...
    private void RetrocederMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RetrocederMouseClicked
        NovaConsulta gm = new NovaConsulta();
        gm.setVisible(true);
        dispose();                
    ...
    private void TabelaListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaListaMouseClicked
        ...
        if(!(medController.existeConsultaData(med, cons.getData()))){
            Short s = 0;
            cons.setRealizado(s);
            cons.setIdMed(med);
            ...
            try {
                cCon.create(cons);
                JOptionPane.showMessageDialog(null, "Consulta registada com sucesso.");
                ...
                JOptionPane.showMessageDialog(null, "Houve um problema a marcar a consulta.");
            }        
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NovaConsulta2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NovaConsulta2().setVisible(true);
            }
        });
    }

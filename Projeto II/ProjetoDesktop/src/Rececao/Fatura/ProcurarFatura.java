 ...
 * @author Nuno
 */
public class ProcurarFatura extends javax.swing.JFrame {
    ...
    public ProcurarFatura() {
        initComponents();
        ImageIcon ic = new ImageIcon(getClass().getResource("/Images/hospital.png"));
        this.setIconImage(ic.getImage());
        setLocationRelativeTo(null);
        
        Object colunas[] = {"Data", "Paciente", "Médico", "Especilidade", "Preço Base", "Iva", "Total"};
    ...
    private void loadData(){
        FaturaJpaController fc = new FaturaJpaController();
        
        
        Object obj[] = new Object[7];
        for(Fatura f : fc.findFaturaEntities()){
            
            obj[0] = f.getIdCons().getData();
            obj[1] = f.getIdCons().getIdPac().getNome().concat(" ").concat(f.getIdCons().getIdPac().getApelido());
            obj[2] = f.getIdCons().getIdMed().getNome().concat(" ").concat(f.getIdCons().getIdMed().getApelido());
            obj[3] = f.getIdCons().getIdMed().getIdEsp().getNome();
            obj[4] = f.getPrecoBase();
            obj[5] = f.getIva();
            obj[6] = f.getPrecoTotal();
    ...
    private void loadData(String nome){
        ...
        Object obj[] = new Object[7];
        for(Fatura f : fc.findFaturaEntities(nome)){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Procurar Fatura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcurarFatura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProcurarFatura().setVisible(true);
            }
        });
    }

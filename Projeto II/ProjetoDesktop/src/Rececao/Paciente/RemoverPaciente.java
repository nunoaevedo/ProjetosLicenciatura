 ...
 * @author Nuno
 */
public class RemoverPaciente extends javax.swing.JFrame {
    ...
    private void loadData(){
        PacienteJpaController pacController = new PacienteJpaController();
        encontrou = false;
        Object obj[] = new Object[9];
        
        for(Object o : pacController.findPacienteEntities()){
            obj[0] = ((Paciente)o).getNome();
            obj[1] = ((Paciente)o).getApelido(); 
            obj[2] = ((Paciente)o).getDataNasc();
            obj[3] = ((Paciente)o).getNif();
            if(null == ((Paciente)o).getSexo()) obj[4] = "";
            else switch (((Paciente)o).getSexo()) {
                case 0:
                    obj[4] = "Masculino";
                    break;
                case 1:
            ...
            obj[5] = ((Paciente)o).getEmail();
            obj[6] = ((Paciente)o).getTelefone();    
            obj[7] = ((Paciente)o).getIdUser().getUsername();
            
            tabela.addRow(obj);
            encontrou = true;
        }
        if (!encontrou){
            JOptionPane.showMessageDialog(null, "Não existem pacientes registados.");
            MenuPaciente gm = new MenuPaciente();
            gm.setVisible(true);
            dispose();
        }
    ...
    private void loadData(String nome){
        ...
        for(Object o : pacController.findPacienteEntities(nome)){
            obj[0] = ((Paciente)o).getNome();
            obj[1] = ((Paciente)o).getApelido(); 
            obj[2] = ((Paciente)o).getDataNasc();
            obj[3] = ((Paciente)o).getNif();
        ...
        if (!encontrou)
            JOptionPane.showMessageDialog(null, "Não existem pacientes com o nome indicado.");
    }
    ...
    private void loadDataPassword(){
        ...
        for(Object o : pacController.findPacienteEntities()){
            ...
            obj[6] = ((Paciente)o).getTelefone();    
            obj[7] = ((Paciente)o).getIdUser().getUsername();
            obj[8] = ((Paciente)o).getIdUser().getPassword();
    ...
    private void TabelaListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaListaMouseClicked
        ...
        Paciente pac = pacController.findPacienteByUser(user);

        int input = JOptionPane.showConfirmDialog(null,
            "Deseja eliminar este paciente?", "Selecione uma opção",JOptionPane.YES_NO_OPTION);

        if(input == 0){
            try {
                pacController.destroy(pac.getId());
                ucontroller.destroy(pac.getIdUser().getId());
                JOptionPane.showMessageDialog(null, "Paciente eliminado.");
                MenuPaciente gm = new MenuPaciente();
                gm.setVisible(true);
                dispose();
            } catch (NonexistentEntityException e) {
                JOptionPane.showMessageDialog(null, "Problema a eliminar paciente.");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverPaciente().setVisible(true);
            }
        });
    }

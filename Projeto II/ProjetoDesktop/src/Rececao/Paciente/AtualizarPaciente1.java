 ...
 * @author Nuno
 */
public class AtualizarPaciente1 extends javax.swing.JFrame {

    
    Paciente pac = new Paciente();
    
    public AtualizarPaciente1() {
    ...
    private void preencheCampos(){
        ...
        SexoBox.setSelectedIndex(pac.getSexo()+1);
    ...
    private Boolean verCampos(){
        return NomeField.getText().isEmpty() || ApelidoField.getText().isEmpty() || EmailField.getText().isEmpty() || RuaField.getText().isEmpty() || UtilizadorField.getText().isEmpty()
                ...
                || TelefoneField.getText().isEmpty() || NISSField.getText().isEmpty() || SexoBox.getSelectedIndex() == 0;
    }
    ...
    private void RetrocederMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RetrocederMouseClicked
        AtualizarPaciente gm = new AtualizarPaciente();
        gm.setVisible(true);
        dispose();                
    ...
    private void AdicionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AdicionarMouseClicked
        ...
        if(verCampos()) JOptionPane.showMessageDialog(null, "Preencha todos os campos.");
        else if(!pac.getIdUser().getUsername().equals(UtilizadorField.getText()) && pac.getIdUser().getId() != pacController.findPacienteByUser(UtilizadorField.getText()).getId())
            ...
            if(!cpController.existeCodpostal(CodPostalField.getText())){
                try {
                    ...
                    Logger.getLogger(AtualizarPaciente1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
           

            Utilizador u = pac.getIdUser();
            ...
            try {
                ...
                pac.setNome(NomeField.getText());
                pac.setApelido(ApelidoField.getText());
                pac.setEmail(EmailField.getText());
                pac.setMorada(RuaField.getText());            
                pac.setCodPostal(cp);           
                pac.setIdUser(u);          
                pac.setDataNasc(DataNascField.getDate());
                pac.setNif(Integer.parseInt(NIFField.getText()));
                pac.setTelefone(Integer.parseInt(TelefoneField.getText()));           
                pac.setSexo(sexo);           
                pac.setNiss(Long.parseLong(NISSField.getText()));

                try {
                    pacController.edit(pac);
                    JOptionPane.showMessageDialog(null, "Paciente registado com sucesso.");
                    GerirMedico gm = new GerirMedico();
                    gm.setVisible(true);
                    dispose();
                } catch (Exception ex) {
                        JOptionPane.showMessageDialog(null, "Hove um problema registar o paciente.");
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Hove um problema registar o nome de utilizador do paciente.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarPaciente1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AtualizarPaciente1().setVisible(true);
            }
        });
    }
